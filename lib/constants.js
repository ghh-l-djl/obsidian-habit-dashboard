...
const VIEW_TYPE = "habit-dashboard-view";
const ICON_ID = "habit-dashboard-icon";
const EVENT_CLIPBOARD_KEY = "__habit_dashboard_clipboard__";
...
const DEFAULT_SETTINGS = {
  ...
  noteOpenMode: "smart",
  archiveFolder: "Habit Dashboard Archive",
  showSection: {
    calendar: true,
    dataLog: true,
    taskBox: true,
